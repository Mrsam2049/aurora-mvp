...
export function createApp() {
  ...
  // Portal autenticado: NO debe quedar en bfcache ni en HTTP cache del navegador.
  // Evita que tras logout + "flecha atrás" se vea el cascarón del dashboard
  // con el correo / títulos de conversaciones de la sesión anterior.
  app.use('/portal', (_req: Request, res: Response, next: NextFunction) => {
